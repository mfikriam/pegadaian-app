...
var nasabahLamaTable = document.querySelector('#nasabah-lama-table');
var addNasabahLamaForm = document.querySelector('#form-add-nasabah-lama');
var updateNasabahLamaBtns = document.querySelectorAll('.btn-update-nasabah-lama');
var deleteNasabahLamaBtns = document.querySelectorAll('.btn-delete-nasabah-lama');
...
if (nasabahLamaTable) {
  ...
  new _simpleDatatables.DataTable(nasabahLamaTable, options);
}

//? Add Data Nasabah Lama
if (addNasabahLamaForm) {
  var addNasabahLamaModal = document.querySelector('#modal-add-nasabah-lama');
  var bsAddNasabahLamaModal = new bootstrap.Modal(addNasabahLamaModal);
  addNasabahLamaForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    if (addNasabahLamaForm.checkValidity()) {
      ...
      (0, _manageData.addNewData)('nasabah-lama', nasabahLamaObj, addNasabahLamaForm, bsAddNasabahLamaModal);
    }
  });
}
...
if (updateNasabahLamaBtns.length > 0) {
  var updateNasabahLamaModalList = document.querySelectorAll('[id^="modal-update-nasabah-lama"]');
  var bsUpdateNasabahLamaModalList = Array.from(updateNasabahLamaModalList).map(function (el) {
    return new bootstrap.Modal(el);
  });
  var updateDataFormList = document.querySelectorAll("[id^=\"form-update-nasabah-lama\"]");
  updateDataFormList.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      form.classList.add('was-validated');
      var nasabahLamaId = form.dataset.objId;
      if (form.checkValidity()) {
        ...
        (0, _manageData.updateDataById)('nasabah-lama', nasabahLamaId, nasabahLamaObj, form, bsUpdateNasabahLamaModalList);
      }
    });
  });
}
...
if (deleteNasabahLamaBtns.length > 0) {
  var deleteNasabahLamaModalList = document.querySelectorAll('[id^="modal-delete-nasabah-lama"]');
  var bsDeleteNasabahLamaModalList = Array.from(deleteNasabahLamaModalList).map(function (el) {
    return new bootstrap.Modal(el);
  });
  deleteNasabahLamaBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var nasabahLamaId = btn.dataset.objId;
      (0, _manageData.delDataById)('nasabah-lama', nasabahLamaId, bsDeleteNasabahLamaModalList);
    });
  });
}
